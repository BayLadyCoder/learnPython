...
print()
print('-------------------------------------------------')
print('Test Case 1: n = 10, L = 10,000')
print('Expected Result: 700,000 ')
print('Actual Result: 700,000')
print('Passed')
print()
print('Test Case 2: n = 12, L = 100,000,')
print('Expected Result: 8,400,000 ')
print('Actual Result: 8,400,000')
print('Passed')
print('-------------------------------------------------')
print('Name: Rachada Chairangsaris (Bay)')
print('Assignment: Lab 1, Part 2')
print('Date: February 1st, 2019')
